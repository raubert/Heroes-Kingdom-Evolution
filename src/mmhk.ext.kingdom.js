...
MMHK.modules.push({
	...
	initialize: function() {
		...
		$.addCss(
		  ...
		  + "#KingdomFrame #KingdomArmiesHeader tr { background-image:url('" + HOMMK.IMG_URL + "/frame/ranking/rankingHeader_DOMINATION_01.jpg') }"
		  ...
		  + "#KingdomFrame #KingdomProductionHeader tr { background-image:url('" + HOMMK.IMG_URL + "/frame/ranking/rankingHeader_WEALTH_01.jpg') }"
		  + "#KingdomFrame #KingdomProductionHeader th div { background-image:url('" + HOMMK.IMG_URL + "/css_sprite/Ressources.gif') }"
		  + "#KingdomFrame #KingdomActionsHeader tr { background-image:url('" + HOMMK.IMG_URL + "/frame/ranking/rankingHeader_HONOR_01.jpg') }"
		  + "#KingdomFrame #KingdomProductionHeader th div { background-image:url('" + HOMMK.IMG_URL + "/css_sprite/Ressources.gif') }"
